...
class LSTM_Autoencoder_RNN:
    ...
    def __init__(self, input_shape, lstm_units=128, dropout_rate=0.5, latent_dim=64, optimizer_autoencoder=Adam(), optimizer_rnn=SGD(learning_rate=0.001, momentum=0.9), patience=3, seed=42):
        self.seed = seed
